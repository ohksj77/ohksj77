...
- **quartz-scheduler/quartz**
  - [PR#1260](https://github.com/quartz-scheduler/quartz/pull/1260) [PR#1261](https://github.com/quartz-scheduler/quartz/pull/1261) _(opened)_
  - 다중 misfired trigger를 retrieve 중 예외 시 롤백 및 재처리로 인한 무한 실패 이슈를 에러 핸들링으로 해결
- **rabbitmq/rabbitmq-java-client**
  - [PR#1469](https://github.com/rabbitmq/rabbitmq-java-client/pull/1469) _(opened)_
