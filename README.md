  ...
  <tr>
    ...
    <td style="vertical-align: top; width: 50%;">
      <details>
        ...
        <ul>
          <li>단순 문제 해결에 그치지 않고 원인과 과정에 대해 고민하며 더 좋은 결과를 만들기 위해 노력합니다. 시스템을 설계하며 단순 목표 tps 만족뿐만 아니라 트래픽이 늘어날 경우 또한 검증했습니다. 그 결과, tps에 따라 수평 확장해야 할 인스턴스 개수를 확인하며 시스템을 완성할 수 있었습니다.</li>
        </ul>
        <h4>프로젝트 전반에 관심을 갖고 여러 개선을 시도합니다.</h4>
        <ul>
          <li>기존의 것에 의문을 제기하고 개선하며 팀에 도움이 되고자 합니다. 서비스의 클라우드 비용을 낭비하고 있음을 파악해 직접 나서 구조를 개선하여 인프라 비용을 절감했습니다.</li>
        </ul>
        <h4>적극적으로 의견을 내고 능동적으로 개발합니다.</h4>
        <ul>
          <li>운영진으로서 의문을 제기하며 동아리의 행사 활성화를 주도적으로 이끌어 동아리 문화를 개선한 경험이 있습니다. 해결해야할 문제가 있을 때 주도적으로 나서는 개발자가 되고자 합니다.</li>
        </ul>
      </details>
    </td>
  </tr>
