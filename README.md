  ...
  <tr>
    ...
    <td style="vertical-align: top; width: 50%;">
      <details>
        ...
        <ul>
          <li>단순 문제 해결에 그치지 않고 원인과 과정에 대해 고민하며 더 좋은 결과를 만들기 위해 노력합니다. 시스템을 설계하며 단순 목표 tps 만족뿐만 아니라 트래픽이 늘어날 경우를 고민했습니다. 그 결과, tps에 따라 수평 확장해야 할 인스턴스 개수를 확인하며 시스템을 완성할 수 있었습니다.</li>
        </ul>
