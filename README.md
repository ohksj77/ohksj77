...
- 데이터 처리의 강점을 가져가며 비즈니스 이해를 이루고자 Nexon Korea에 합류해 매달 다수의 운영 업무와 함께 안정성 있는 개발을 경험했습니다.
- 비즈니스 이해 뿐만 아니라 복구 가능하도록 서버 안정성을 더하는 경험을 하며 기술적인 고민과 시스템에 안정성을 더하는 업무에 흥미를 느꼈습니다.
- 이러한 업무를 위주로 더욱 큰 성과를 내고자 도전 중입니다.
