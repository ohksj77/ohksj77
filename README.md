...
## 🎙️ Introduce
#### _`#부하분산시스템설계` `#실시간시스템설계` `#대용량데이터처리` `#인프라비용절감`_ <br> _`#오픈소스기여` `#인턴경력` `#서비스운영` `#IT동아리운영진` `#공모전수상`_
  ...
  <tr>
    <td style="vertical-align: top; width: 50%;">
      <details>
        ...
        <hr>
        <h4>상황에 맞는 최적의 방법을 고민해 문제를 해결하는 백엔드 엔지니어입니다.</h4>
        <ul>
          <li>100만 건 대용량 데이터를 인프라 변경없이 처리하기 위해 API 서버에서 직접 부하분산하는 시스템을 설계했습니다.</li>
        </ul>
